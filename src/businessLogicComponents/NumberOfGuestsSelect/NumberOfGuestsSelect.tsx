...
const NumberOfGuestsSelect: FC<NumberOfGuestsSelectProps> = ({
  ...
  return (
    ...
    >
      <Button
        type={tableBookingPageData?.numberOfGuestsForm?.minusButton.type}
        size="l"
        shape="circle"
        ariaLabel={
          tableBookingPageData?.numberOfGuestsForm?.minusButton.ariaLabel
        }
        disabled={guests < 1}
        variant="secondary"
        onClick={() => setGuests((g) => Math.max(0, g - 1))}
      >
        {tableBookingPageData?.numberOfGuestsForm?.minusButton.buttonText}
      </Button>
      <TextField
        htmlFor={
          tableBookingPageData?.numberOfGuestsForm?.numberOfGuestsInput?.htmlFor
        }
        label={
          tableBookingPageData?.numberOfGuestsForm?.numberOfGuestsInput?.label
        }
        type={
          tableBookingPageData?.numberOfGuestsForm?.numberOfGuestsInput?.type
        }
        name={
          tableBookingPageData?.numberOfGuestsForm?.numberOfGuestsInput?.name
        }
        ariaLabel={
      ...
      <Button
        ...
        size="l"
        ariaLabel={
          tableBookingPageData?.numberOfGuestsForm?.plusButton.ariaLabel
        }
        disabled={guests === 12}
        shape="circle"
        variant="primary"
      ...
      >
        {tableBookingPageData?.numberOfGuestsForm?.plusButton.buttonText}
      </Button>
    </Flex>
  );
};
